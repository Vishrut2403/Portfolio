...
export default class Controller
{
    ...
    setProjectControls()
    {
        ...
        this.projectControls.projectEnter = async () =>
        {
            if (this.logic.buttonsLocked === false && this.logic.mode === 'projects0') {
                this.sounds.playBloop()
                this.logic.mode = 'more-projects'
                window.open('https://1drv.ms/f/c/213c3ae49054d20d/Eg3SVJDkOjwggCGEAAAAAAABuGWSftI6v_C8TzBxB4Iryg?e=SpbQ6a', '_blank')
            }
        }
    }
    ...
    setMenuControls()
    {
        ...
        this.menuControls.articles = async (obj, color) =>
        {
            if(this.logic.buttonsLocked === false && this.logic.mode === 'menu')
            {
                ...
                window.open('https://www.linkedin.com/in/vishrut-sachan-72a9a1284', '_blank')
            }
        }
    ...
    setVideoControls()
    {
        ...
        this.videoControls.tvScreen = async () =>
        {
            ...
            {this.resources.video['tvScreenVideoTexture'].play()}
                ...
                window.open('https://1drv.ms/v/c/213c3ae49054d20d/EQ3SVJDkOjwggCEjAwAAAAABIGUqS4faTfnpItSphGGYgA?e=bLDDy3', '_blank');
    ...
    setSocialControls()
    {
        ...
        this.socialControls.twitter = async () =>
        {
            if(this.logic.buttonsLocked === false && (this.logic.mode === 'aboutMe' || this.logic.mode === 'skills' || this.logic.mode === 'experience'))
            {
                window.open('https://www.instagram.com/vishrut_animations/', '_blank');
            }
        ...
        this.socialControls.gitHub = async () =>
        {
            if(this.logic.buttonsLocked === false && (this.logic.mode === 'aboutMe' || this.logic.mode === 'skills' || this.logic.mode === 'experience'))
            {
                window.open('https://github.com/Vishrut2403', '_blank');
            }
